                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @foreach($lib as $li)
                                @if($li -> Rent_Status == 'Rented by '.Auth::user()->name)
                                    <b> You rented</b> {{$li->Title}} <b>by </b> {{$li->Name}} <b>in </b> {{\Carbon\Carbon::parse($li->Rent_Date)->diffForHumans() }} <br>
                                    <form method="POST" action="{{url('return/'.$li->id)}}">
                                        @csrf
                            ...
                            @foreach($lib as $li)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <p class="text-gray-400">Reserved</p>
                                        @endif
